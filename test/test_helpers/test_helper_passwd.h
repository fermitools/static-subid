 ...
 * - mock_getpwuid_longname: Very long username (255 chars, for buffer overflow testing)
 ...
 */
static struct passwd *setup_mock_user(const char *username, uid_t uid, gid_t gid)
{
 ...
 * Return: 0 on success
 */
static int mock_getpwnam_r_success(const char *name, struct passwd *pwd, char *buf,
 ...
 */
static int mock_getpwnam_r_not_found(const char *name, struct passwd *pwd, char *buf,
				     size_t buflen, struct passwd **result)
{
	(void)name;
	(void)pwd;
 ...
 */
static int mock_getpwnam_r_error(const char *name, struct passwd *pwd, char *buf,
				 size_t buflen, struct passwd **result)
{
	(void)name;
	(void)pwd;
