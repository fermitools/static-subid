...
/**
 * mock_lstat_root_dir_world_write - Mock lstat for world-writable root directory
 * @pathname: Path to stat (ignored)
 * @statbuf: Stat buffer (populated)
 *
 ...
 * Return: 0 (success)
 */
static int mock_lstat_root_dir_world_write(const char *pathname, struct stat *statbuf)
{
	(void)pathname;
	statbuf->st_uid = 0;
 ...
 * Return: 0 (success)
 */
static int mock_lstat_root_file_world_write(const char *pathname, struct stat *statbuf)
{
	(void)pathname;
	statbuf->st_uid = 0;
 ...
 * Return: 0 (success)
 */
static int mock_lstat_non_root_file(const char *pathname, struct stat *statbuf)
{
	(void)pathname;
	statbuf->st_uid = 1000;
	statbuf->st_mode = S_IFREG | 0644;
...
/**
 * mock_fstat_root_dir_world_write - Mock fstat for world-writable root directory
 * @fd: File descriptor (ignored)
 * @statbuf: Stat buffer (populated)
 *
 * Simulates a directory owned by root with unsafe permissions (0777).
 ...
 * Return: 0 (success)
 */
static int mock_stat_root_dir_world_write(const char *pathname, struct stat *statbuf)
{
	(void)pathname;
	statbuf->st_uid = 0;
	statbuf->st_mode = S_IFDIR | 0777;
